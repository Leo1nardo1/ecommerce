          ...
          <main class="w-full max-w-md mx-auto p-6">
            <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <div class="p-4 sm:p-7">
               ...
               <!-- Display error message in case the password reset link has been used before or the link is expired-->
                    @if (session('error'))
                     <div class="mt-2 mb-4 bg-red-500 text-sm text-white rounded-lg p-4" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-danger-label">
                        {{ session('error') }}
                    </div> 
                     @endif
                      <!-- Form Group -->
