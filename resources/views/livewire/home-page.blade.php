<div>
    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          ...
          <p class="mt-3 text-lg text-gray-800 dark:text-white">Purchase wide varities of electronics products like Cellphones, Computers, Headphones and many more.</p>
  ...
  <div class="bg-lime-200 py-20">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-700"> Browse <span class="text-emerald-500"> Categories
            </span> </h1>
          <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
            <div class="flex-1 h-2 bg-green-200">
            </div>
