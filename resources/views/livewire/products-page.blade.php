        ...
        <div class="flex flex-wrap mb-24 -mx-3">
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
              {{--This is used to access the categories id when you click in the checkbox and see if it works--}}
              ...
              <ul>
                ...
                <li class="mb-4" wire:key="{{ $category->id }}">
                  <label for="{{ $category->slug }}" class="flex items-center dark:text-gray-400 ">
                    {{--Wire model.live putz the selected checkbox inside of the "selected_categories" variable (ProductsPage--}}
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <div>
                {{--This div shows the value selected (above the price range)--}}
                <div class="font-semibold dark:text-white">{{ Number::currency($price_range, 'USD') }}</div>
                {{--step é o valor que será incrementado ao slider quando movido--}}
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="15000" value="1000" step="1000">
                <div class="flex justify-between ">
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency('1000', 'USD') }}</span>
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency('15000', 'USD') }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="w-full px-3 lg:w-3/4">
            <div class="px-3 mb-4">
              <div class="items-center justify-end px-3 py-2 bg-gray-100 flex dark:bg-gray-900">
                <div class="flex items-center justify-between">
                  <div class="relative">
                    <select wire:model.live="sort" class="block w-40 text-base pl-10 pr-3 bg-gray-100 cursor-pointer dark:text-gray-400 dark:bg-gray-900 appearance-none">
                ...
                <div class="border border-gray-300 dark:border-gray-700">
                  <div class="relative bg-green-200">
                    <a href="/products/{{ $product->slug }}" class="">
                      <img src="{{ url('storage', $product->images[0]) }}" alt="" class="object-contain w-full h-56 mx-auto ">
                    </a>
                  </div>
                  <div class="p-3 ">
                    <div class="flex items-center justify-between gap-2 mb-2">
                      <h3 class="text-base font-medium dark:text-gray-400">
                        {{ $product->name }}
                      </h3>
                    </div>
                    <p class="text-lg ">
