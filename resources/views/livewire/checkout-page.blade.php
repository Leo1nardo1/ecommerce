                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <!-- inside of this class, we see an error, this is used to make the border becomes green, the other error message after input is used to display an error text below the input field -->
                        ...
                        <li class="py-3 sm:py-4" wire:key="{{ $cart_item['product_id'] }}">
                            <div class="flex items-center">
                                ...
                                <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                    {{ Number::currency($cart_item['total_amount'], 'USD') }}
                                </div>
                            </div>
                        </li>
